...
namespace CardSharp.Tests {
    ...
    public class CardTests {
        ...
        public void Card_SingleCard_ConvertToList() {
            ...
            CollectionAssert.AreEqual(new[] { card }, (Card<int>[])card);
        }
        ...
        public void Card_ListOf1Cards_ConvertToSingleCard() {
            ...
            Assert.AreEqual<Card<int>>(card, new Card<int>[] { card });
        }
        ...
        public void Card_ListOf3CardsCard_Throws() {
            ...
            var array = new[] { card, card };

            var exception = Assert.ThrowsException<InvalidCastException>(() => (Card<int>)array);
